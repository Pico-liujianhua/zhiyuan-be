...
public class AuthController {
    ...
    public WechatLoginUrlResponse wechatLoginUrl(@RequestParam(value = "returnUrl", required = false) String returnUrl) {
        return authService.buildWechatLoginUrl(returnUrl);
    }

    @GetMapping("/wechat/callback")
    public ResponseEntity<Void> wechatCallback(@RequestParam("code") String code,
                                               @RequestParam("state") String state,
                                               HttpServletRequest httpRequest) {
        String redirectUrl = authService.handleWechatCallback(code, state, resolveClient(httpRequest));
